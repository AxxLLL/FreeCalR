...
class CalendarManagerTest {
    ...
    void test_14() {
        ...
        for(int i = 0; i < 12; i ++) {
            ...
            defaultCalendarManager = defaultCalendarManager.switchToNextYear();
    ...
    void test_15() {
        ...
        for(int i = 0; i < 12; i ++) {
            assertThat(defaultCalendarManager.getYear()).isEqualTo(currYear --);
            defaultCalendarManager = defaultCalendarManager.switchToPreviousYear();
            assertThat(defaultCalendarManager).isExactlyInstanceOf(CalendarManager.class);
        }
    }
    ...
    void test_16() {
        ...
        assertThat(localManager = localManager.switchToPreviousYear()).isExactlyInstanceOf(CalendarManager.class);
        CalendarManager finalLocalManager = localManager;
        assertThatIllegalArgumentException().isThrownBy(() -> finalLocalManager.switchToPreviousYear());
    }
    ...
    void test_17() {
        ...
        for(int i = 0; i < 11; i ++) {
            ...
            assertThat((localManager = localManager.switchToNextMonth())).isExactlyInstanceOf(CalendarManager.class);
        }
    }
    ...
    void test_18() {
        ...
        for(int i = 0; i < 11; i ++) {
            ...
            assertThat((localManager = localManager.switchToPreviousMonth())).isExactlyInstanceOf(CalendarManager.class);
        }
    }
    ...
    void test_19() {
        CalendarManager localManager = CalendarManager.of(freeDaysManager, Month.DECEMBER, 2018);
        assertThatIllegalStateException().isThrownBy(() -> localManager.switchToNextMonth());
    }
    ...
    void test_20() {
        CalendarManager localManager = CalendarManager.of(freeDaysManager, Month.JANUARY, 2018);
        assertThatIllegalStateException().isThrownBy(() -> localManager.switchToPreviousMonth());
    }
}